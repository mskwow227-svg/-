...
window.OL = {
  event: {
    ...
    timeLabel: '09:30 접수 ~ 15:00 폐회식 (개회식 10:30)',
  ...
  timetable: [
    ...
    { time: '11:00–14:00', title: '체험부스 · 푸드트럭', desc: '산림·아웃도어 체험부스 운영, 스탬프 투어 완주자 푸드트럭 이용' },
  ...
  // 스탬프 투어 부스
  booths: [
    { id: 1, icon: '🧭', tag: '사전 교육',  title: '초보자 맞춤 교육부스',        desc: '본 대회 시작 전 나침반 사용법과 지도 읽기 기초를 쉽고 친절하게 배워볼 수 있는 필수 교육 코너입니다.' },
    { id: 2, icon: '🎯', tag: '동아리 기획', title: '동아리 기획 미니 오리엔티어링', desc: '청소년 동아리가 직접 참신하게 기획하고 운영하는 체험부스로 재미있는 미션 게임이 함께 진행됩니다.' },
